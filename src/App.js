      ...
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>IsraelStock</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>Israel <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">IsraelStockFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
          ...
          <section className="contributors">
            ...
            <div className="contributor-previews">
              ...
              <div className="contributor-preview">
                <iframe title="yt2" width="350" height="195" src="https://player.vimeo.com/video/58204659" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt3" width="350" height="195" src="https://www.youtube.com/embed/LER7lcnzoDU" frameBorder="0" allowFullScreen></iframe>
              </div>
            </div>
            ...
            <div className="mobile-contributor-previews">
              ...
              <div className="contributor-preview">
                <iframe title="yt5" width="250" height="150" src="https://player.vimeo.com/video/58204659" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt6" width="250" height="150" src="https://www.youtube.com/embed/LER7lcnzoDU" frameBorder="0" allowFullScreen></iframe>
              </div>
            </div>

            <br/>
            <p>Download high quality royalty-free 4K and HD stock video footage clips from the most popular travel locations in Israel including: Jerusalem, Palestine, The Dead Sea, The Sea of Galilee, The Jordan River, Ein Gedi, Tel Aviv, Caesarea, Beit She'an, Capernaum, Western Wall, Dome of the Rock, and Al-Aqsa Mosque. Contact us about selling your own stock footage through our online community.</p>
          </section>
          <br/>
        </div>
        <Footer/>
